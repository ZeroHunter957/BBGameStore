...
<head>
    ...
    <link id="rtl-link" rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/bootstrap.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('../css_cart/css/vendors/ion.rangeSlider.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/font-awesome.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/feather-icon.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/animate.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/slick/slick.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/vendors/slick/slick-theme.css')); ?>">
    <link id="color-link" rel="stylesheet" type="text/css" href="<?php echo e(asset('../css_cart/css/demo4.css')); ?>">
...
<body>
                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <?php if(session()->has('accountLogin')): ?>
                                    <li>
    ...
    <script src="<?php echo e(asset('css_cart/js/jquery-3.5.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/bootstrap/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/feather/feather.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/lazysizes.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/slick/slick.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/slick/slick-animation.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/slick/custom_slick.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/price-filter.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/ion.rangeSlider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/filter.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/newsletter.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/cart_modal_resize.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/bootstrap/bootstrap-notify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/theme-setting.js')); ?>"></script>
    <script src="<?php echo e(asset('css_cart/js/script.js')); ?>"></script>
    <script>
        $(function() {
...
<?php /**PATH /Users/macs/Documents/Zalo Received Files/BBGameStore-Bao 2/resources/views/layouts/user.blade.php ENDPATH**/ ?>