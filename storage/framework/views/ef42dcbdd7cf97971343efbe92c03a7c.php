...
/* Tiêu đề của Game Categories List */
h2 {
    font-size: 2rem;
    font-weight: 600;
    color: #333;
...
/* Nút "Create a new Game Category" */
.btn-primary {
...
/* Bảng hiển thị danh sách Game Categories */
.table-responsive {
    width: 100%;
    overflow-x: auto;
    padding: 20px;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\bbgame\BBgame\resources\views/gamecategory/index.blade.php ENDPATH**/ ?>