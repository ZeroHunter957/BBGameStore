                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="star-rating">
                                                    <input type="radio" id="star5" name="star" value="5"
                                                        required><label for="star5" class="fa fa-star"></label>
                                                    <input type="radio" id="star4" name="star"
                                                        value="4"><label for="star4" class="fa fa-star"></label>
                                                    <input type="radio" id="star3" name="star"
                                                        value="3"><label for="star3" class="fa fa-star"></label>
                                                    <input type="radio" id="star2" name="star"
                                                        value="2"><label for="star2" class="fa fa-star"></label>
                                                    <input type="radio" id="star1" name="star"
                                                        value="1"><label for="star1" class="fa fa-star"></label>
                                                </div>
                                            </div>
