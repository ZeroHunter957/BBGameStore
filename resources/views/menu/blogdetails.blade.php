...
<div class="page-heading header-text">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h3>{{ $blog->title }}</h3>
        <h6>Created at {{ $blog->created_at }}</h6>
        <h6>Created by {{ $blog->account->fullname }}</h6>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  ...
  <div class="comment">
    <div class="user-info">
      <img src="{{ url('profile_images/' . $comment->account->profile_image ) }}" alt="Avatar" class="avatar">
      <h5>{{ $comment->account->fullname }}</h5>
    </div>
    <p>{!! $comment->content !!}</p>
  ...
  @else
  <a href="{{ route('account.login') }}" class="btn btn-primary">Login to Comment</a>
  @endif
</div>
