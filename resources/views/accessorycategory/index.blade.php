                ...
                <tbody>
                    @foreach ($accessorycategories as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Edit Button -->
                                <a href="{{ route('accessorycategory.edit', $item->id) }}" class="btn btn-warning btn-sm">
                                    Edit
                                </a>

                                <!-- Delete Button -->
                                {{-- <form action="{{ route('accessorycategory.destroy', $item->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
